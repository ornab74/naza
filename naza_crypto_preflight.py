...
def main() -> None:
    ...
    context = b"naza/runtime-preflight/v2"
    ...
    # Orbit simulator must reproduce the supplied calibration ephemeris to its
    # published rounding precision before it is allowed into scanner prompts.
